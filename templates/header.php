...
<html lang="en">
	<head>
		...
		<meta name="theme-color" content="#7c5ffa">
		<!-- Windows Phone -->
		<meta name="msapplication-navbutton-color" content="#7c5ffa">
		<!-- iOS Safari -->
		<meta name="apple-mobile-web-app-status-bar-style" content="#7c5ffa">
		<title>iDance Studio &#124; WORLD of International Dance  for Kids and Adults in Brooklyn N</title>
		<!-- Favicon -->
						...
						<ul class="clearfix">
							...
							<li class="search-option">
						 		<div class="dropdown">
									...
									<form action="#" class="dropdown-menu dropdown-menu-right">
