<?php include('templates/header_page.php');?>
			...
			<div class="theme-inner-banner">
				...
				<div class="container">
					<h2 class="title">Studio Rental</h2>
				</div> <!-- /.container -->
			...
			<div class="section-spacing section-spacing-bottom">
				<div class="container">
						...
						<div class="row">
							<div class="col-md-6">
								<div class="img-class">
									<img class="img-fluid" src="images/MILLENNIUM1.jpg">
								</div>
							</div>
							<div class="col-md-6">
								<div class="img-class">
									<img class="img-fluid" src="images/hall.jpg">
								</div>
							</div>
						</div>
						...
						<div class="row">
							<div class="col-md">
								<div class="rental-container">
									<div class="rental-img"><img src="images/icons/area.svg" alt=""></div>
									<div>650 ft2</div>
							...
							<div class="col-md">
								<div class="rental-container">
									<div class="rental-img"><img src="images/icons/wood.svg" alt=""></div>
									<div>Wood Parquet</div>
								</div>
							</div>
							<div class="col-md">
								<div class="rental-container">
									<div class="rental-img"><img src="images/icons/barres.svg" alt=""></div>
									<div>Portble freestanding ballet barres</div>
								</div>
							</div>
							<div class="col-md">
								<div class="rental-container">
									<div class="rental-img"><img src="images/icons/mirrors.svg" alt=""></div>
									<div>Mirrors</div>
								</div>
							</div>
							<div class="col-md">
								<div class="rental-container">
									<div class="rental-img"><img src="images/icons/speaker.svg" alt=""></div>
								<div>Audio Equipment</div>
								</div>
							</div>
							<div class="col-md">
								<div class="rental-container">
									<div class="rental-img"><img src="images/icons/air.svg" alt=""></div>
						...
						<div class="row">
							<div class="col-md-4">
								<div class="rental__price">
									<div class="rental__price-header">
										<h4>Peak hours (5pm-9pm)</h4>
									</div>
									<div class="rental__price-text">
										<ul>
											<li><strong>Week days and Weekends</strong></li>
											<li>1-3 people: $40 / hour</li>
											<li>4-8 people: $60 / hour</li>
											<li>9 people and up: $100/ an hour</li>
										</ul>
									</div>
								</div>
							</div>
							<div class="col-md-4">
								<div class="rental__price">
									<div class="rental__price-header">
										<h4>Off peak hours (9am-5pm)</h4>
									</div>
									<div class="rental__price-text">
										<ul>
											<li>1-3 people: $20 / hour</li>
											<li>4-8 people: $30 / hour</li>
											<li>9 people and up: $50/ an hour</li>
										</ul>
									</div>
								</div>
							</div>
							<div class="col-md-4">
								<div class="rental__price">
									<div class="rental__price-header">
										<h4>All day Rental (9am-9pm)</h4>
									</div>
									<div class="rental__price-text">
										<ul>
											<li><strong>All day $250.00</strong></li>
										</ul>
									</div>
								</div>
							</div>
					...
					<div class="section-spacing">
						<div class="rental__price-pay">
							<h2>Choose your plan</h2>
							<p>To secure your date, time and hour you must call or text us first then submit deposit: <a href="tel:917-332-84-74">917-332-84-74</a></p>
							<p>Deposit is <strong>non refoundable</strong> but you can reschedule your timing</p>
							<select name="" id="" class="select">
								<option value="">1 hour $5.00 USD</option>
								<option value="">2 hour $10.00 USD</option>
								<option value="">3 hour $15.00 USD</option>
							</select>
						</div>
					</div>
				</div>
